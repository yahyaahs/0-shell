use std::{fs::{exists, metadata, read_dir, read_to_string, remove_dir_all, remove_file, create_dir}, io::*};

use crate::shell::exec::builtins::{copyf::{create_file, copy_perms}, mkdir::create_folder};
